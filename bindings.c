    ...
    LIB_RUBY_PARSER_ByteList_BLOB input_blob)
{
    ...
    LIB_RUBY_PARSER_DecoderResult result = self->f(self, encoding, input);
    return PACK_DecoderResult(result);
}
void lib_ruby_parser__external__decoder_drop(LIB_RUBY_PARSER_Decoder_BLOB *self_blob)
{
    (void)self_blob;
}
LIB_RUBY_PARSER_Decoder_BLOB lib_ruby_parser__external__decoder__new(LIB_RUBY_PARSER_decode_t f)
{
    ...
    LIB_RUBY_PARSER_SharedByteList_BLOB input_blob)
{
    ...
    LIB_RUBY_PARSER_Token *token = UNPACK_Ptr(token_blob);
    LIB_RUBY_PARSER_SharedByteList input = UNPACK_SharedByteList(input_blob);

    LIB_RUBY_PARSER_TokenRewriterResult result = self->rewrite_f(self, token, input);
