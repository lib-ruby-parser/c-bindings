...
LIB_RUBY_PARSER_SourceLine lib_ruby_parser__test__make_source_line_1_2_true();
test(source_line_fields, {
    LIB_RUBY_PARSER_SourceLine source_line = lib_ruby_parser__test__make_source_line_1_2_true();
    assert_source_line(source_line, 1, 2, true);
});

LIB_RUBY_PARSER_SourceLineList lib_ruby_parser__test__make_source_line_list();
