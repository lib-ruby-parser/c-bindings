...
typedef LIB_RUBY_PARSER_DecoderResult (*LIB_RUBY_PARSER_decode_t)(struct LIB_RUBY_PARSER_Decoder *, LIB_RUBY_PARSER_StringPtr, LIB_RUBY_PARSER_ByteList);
typedef struct LIB_RUBY_PARSER_Decoder
{
    LIB_RUBY_PARSER_decode_t f;
...
typedef LIB_RUBY_PARSER_TokenRewriterResult (*LIB_RUBY_PARSER_rewrite_token_t)(struct LIB_RUBY_PARSER_TokenRewriter *, LIB_RUBY_PARSER_Token *, LIB_RUBY_PARSER_SharedByteList);
